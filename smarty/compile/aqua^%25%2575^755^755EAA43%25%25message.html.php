...
?>
        				<?php if ($this->_tpl_vars['settings']['user']): ?>
        					<?php $this->assign('href', ($this->_tpl_vars['settings']['path'])."users/order/?service=".($this->_tpl_vars['serv']['type'])."&message_id=".($this->_tpl_vars['message']['id'])); ?>
        				    <?php $this->assign('iframeclass', ''); ?>
                        <?php else: ?>
